  ...
  const events: ScheduleEvent[] = [
    {
      ...
      description: "Guests arrive and are seated at St. Therese of the Child Jesus and the Holy Face Parish Church."
    },
    {
      title: "Holy Mass & Ceremony",
      time: "1:00 PM - 2:15 PM",
      description: "Celebration of the Holy Eucharist followed by the exchange of vows and rings."
    },
    {
      title: "Photo Session",
    ...
    },
    {
      ...
      description: "Guests arrive at Mountain Rock Resort for cocktails and appetizers."
    },
    {
      title: "Grand Entrance",
      time: "5:15 PM - 5:30 PM",
      description: "Introduction of the wedding party and grand entrance of the newlyweds."
    },
    {
      title: "Dinner & Program",
      time: "5:30 PM - 8:00 PM",
      description: "Dinner service, toasts, speeches, traditional dances, and games."
    },
    {
      title: "Dancing & Celebration",
      time: "8:00 PM - 10:00 PM",
      description: "First dance, cake cutting, and open dance floor for all guests."
    }
  ];
    ...
    <section id="schedule" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 opacity-5">
        <svg width="200" height="200" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2M12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4M12.5 7L11 7.75V12.5H15V11H12.5V7Z" fill="#6b0f2b" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-10">
          <div className="flex items-center bg-[#fff5f7] px-6 py-3 rounded-full shadow-sm border border-[#e8c1c8]">
            ...
            <span className="font-['Cormorant_Garamond'] text-xl text-[#6b0f2b]">May 3, 2025</span>
          </div>
        </div>
            ...
            >
              ...
              <div className="md:w-1/2 md:pr-16 md:text-right mb-6 md:mb-0">
                <div className="bg-white p-4 rounded-lg shadow-sm border border-[#e8c1c8] md:ml-auto md:mr-0 md:max-w-xs">
                  <h3 className="font-['Cormorant_Garamond'] text-xl text-[#6b0f2b] mb-1">{event.title}</h3>
                  <p className="text-[#4a5568] font-medium text-sm mb-0">{event.time}</p>
                </div>
              </div>
              
              <div className="md:w-1/2 md:pl-16">
                <div className="bg-[#fff5f7] p-4 rounded-lg shadow-sm border border-[#e8c1c8] md:mr-auto md:ml-0 md:max-w-xs">
                  <p className="text-[#4a5568] font-['Cormorant_Garamond'] text-lg mb-0">{event.description}</p>
                </div>
              </div>
            </motion.div>
          ))}

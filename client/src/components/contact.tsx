...
const Contact = () => {
  const contactItems = [
    {
      ...
      title: "Phone",
      details: [
        "Jeshua: +63 921 397 3751",
        "Judel: +63 956 788 1254"
      ]
    },
    {
      ...
      title: "Email",
      details: [
        "wedding@jeshuaandjudel.com",
        "rsvp@jeshuaandjudel.com"
      ]
    },
    {
  ...
  return (
    <section id="contact" className="py-16 bg-[#fff5f7] relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4">
        ...
        <motion.p 
          ...
          viewport={{ once: true }}
        >
          For any questions or assistance regarding our wedding, please don't hesitate to reach out to us.
        </motion.p>
        ...
        >
          {contactItems.map((item, index) => (
            <motion.div 
              ...
              whileHover={{ 
                y: -5,
                boxShadow: "0 10px 25px -5px rgba(107, 15, 43, 0.1), 0 8px 10px -6px rgba(107, 15, 43, 0.1)"
              }}
            >
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-[#fff5f7] text-[#6b0f2b] mb-6 shadow-sm">
                {item.icon}
              </div>
              <h3 className="font-['Cormorant_Garamond'] text-xl text-[#6b0f2b] mb-3">{item.title}</h3>
